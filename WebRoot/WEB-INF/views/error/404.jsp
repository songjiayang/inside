...
<body>
<div class="bg_border" style="background:url(${ctx}/static/images/secondary_market/element/404.png);">
<div class="out_border" >
<a href="${ctx}/index" style="text-decoration:none;"><input type="button" class="login" id="login" name="login" value="返回主页" style="margin-top:230px; margin-right:150px;"/>
</a>
</div>
</div>
