...
<body>
	<form action="user/activeuser/resendpassword" method="post" >
...
<div class="in_border">
  ...
  <div class="login_hui">密码修改邮件已发至你的邮箱。</div>
  ...
  <div class="login_hui">没有收到密码修改邮件？</div>
  <div class="tip"  style="height:20px;">-试试到邮箱中的垃圾邮件、广告邮件目录中找找</div>
  <div class="tip"  style="height:20px;">-或者，<a onclick="dosubmit()" style="text-decoration: none; color: #069">重新发邮件</a></div>
  <div class="tip">如果仍然无法修改，请将情况描述发送给in_side@sina.com</div>
</div>
</form>
</body>
</html>