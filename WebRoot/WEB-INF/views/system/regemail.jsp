...
<input type="hidden" value="<%=user.getEmail()%>" id="email" name="email"/>
  ...
  <div class="login_hui">马上激活邮箱，完成注册</div>
...
<div class="bottom" style="position:fixed; bottom:0px;">
<div class="bottom_line" > Copyright © 20012-2012 XXXX科技有限公司 Inc.All rights reserved 闽ICP备07050274号 </div>
</div>
</form>
</body>
</html>
