...
<div class="content">
 ...
 <form action="${ctx}/user/pass_change" method="post">
  <div class="input_border" style="margin:10px auto;" >
  <div class="tittle">原始密码:</div>
  <div class="input"><input type="password" id="oldpass" name="oldpass" tabindex="2" class="input" <c:if test="${!empty error1}">${oldpass}</c:if>/></div>
